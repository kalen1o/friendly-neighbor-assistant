...
async def test_solar_to_lunar_user_original_today():
    ...
    r = await execute_lunar_convert(direction="solar_to_lunar", year=2026, month=4, day=17)
    src = r["sources"][0]
...
async def test_lunar_to_solar_user_original_question():
    ...
    r = await execute_lunar_convert(direction="lunar_to_solar", year=2026, month=4, day=30)
    assert r["sources"] == []
...
async def test_lunar_to_solar_last_day_of_lunar_month():
    r = await execute_lunar_convert(direction="lunar_to_solar", year=2026, month=4, day=29)
    src = r["sources"][0]
...
async def test_lunar_to_solar_first_day_next_lunar_month():
    ...
    r = await execute_lunar_convert(direction="lunar_to_solar", year=2026, month=5, day=1)
    src = r["sources"][0]
...
async def test_tet_2026_is_bing_wu():
    ...
    r = await execute_lunar_convert(direction="lunar_to_solar", year=2026, month=1, day=1)
    src = r["sources"][0]
...
async def test_tet_2024_is_giap_thin():
    ...
    r = await execute_lunar_convert(direction="lunar_to_solar", year=2024, month=1, day=1)
    src = r["sources"][0]
...
async def test_tet_2025_is_at_ty():
    ...
    r = await execute_lunar_convert(direction="lunar_to_solar", year=2025, month=1, day=1)
    src = r["sources"][0]
...
async def test_invalid_lunar_year():
    r = await execute_lunar_convert(direction="lunar_to_solar", year=1800, month=1, day=1)
    assert r["sources"] == []
